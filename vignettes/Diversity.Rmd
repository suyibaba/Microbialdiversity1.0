...
vignette: >
  ...
  %\VignetteDepends{Microbialdiversity1.0}
---
...
```{r setup}
if (requireNamespace("Microbialdiversity1.0", quietly = TRUE)) {
  library(Microbialdiversity1.0, quietly = TRUE)
} else {
  stop("Microbialdiversity1.0 package is required but not installed")
}
```
