...
The Microbialdiversity1.0 package provides a user-friendly way to perform these calculations and visualize the results.
...
Shannon Diversity Index:Ranges from 0 to ln(S), where S is the number of species Higher values indicate greater diversity Considers both richness and evenness, Sensitive to rare species
Simpson Diversity Index (1-D):  Ranges from 0 (low diversity) to 1 (high diversity) Emphasizes dominant species Less sensitive to rare species
Value represents probability that two randomly selected individuals belong to different species
Inverse Simpson Index :Ranges from 1 to the number of species Higher values indicate greater diversity, Gives more weight to abundant species
Less influenced by rare species
Observed OTUs: Simple count of species present (abundance > 0), Measures species richness, Does not consider relative abundances Useful for comparing basic community composition
P-values
